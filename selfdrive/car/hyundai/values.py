...
FEATURES = {
  ...
  "use_elect_gears": [CAR.KIA_OPTIMA_H, CAR.IONIQ_EV_LTD, CAR.KONA_EV, CAR.IONIQ, CAR.SONATA_H, CAR.KIA_NIRO_EV],
...
EV_HYBRID = [CAR.IONIQ_EV_LTD, CAR.IONIQ, CAR.KONA_EV, CAR.SONATA_H]
