...
class CarState():
  ...
  def update(self, cp, cp2, cp_cam):
    ...
    if self.v_ego > 15.0 and not self.left_blinker_on:
    ...
    elif self.v_ego > 15.0 and self.right_blinker_on:
